...
ruby S:\resources\bookmaker_scripts\bookmaker_addons\egalleymaker_htmlmaker_postprocessing.rb '%infile%' >> %logfile% 2>&1 && call :ProcessLogger egalleymaker_htmlmaker_postprocessing
...
SET SSL_CERT_FILE=C:\Ruby193\lib\ruby\site_ruby\1.9.1\rubygems\ssl_certs\cacert.pem >> %logfile% 2>&1 && call :ProcessLogger cacert
ruby S:\resources\bookmaker_scripts\covermaker\bookmaker_covermaker.rb '%infile%' >> %logfile% 2>&1 && call :ProcessLogger covermaker
...
ruby S:\resources\bookmaker_scripts\bookmaker_connectors\egalley_distribute.rb '%infile%' >> %logfile% 2>&1 && call :ProcessLogger egalley_distribute
ruby S:\resources\bookmaker_scripts\bookmaker_validator\deploy_posts.rb '%infile%' >> %logfile% 2>&1 && call :ProcessLogger validator_posts
