...
set p_log="S:\resources\logs\processLogs\%~n1_%mydate%-%mytime%_egalleySMP.txt"
set p_log_tmp="S:\resources\logs\processLogs\%~n1_%mydate%-%mytime%_egalleySMPTmp.txt"
