...
REM PowerShell -NoProfile -ExecutionPolicy Bypass -Command "S:\resources\bookmaker_scripts\WordXML-to-HTML\DocxToXml.ps1 '%1'"
...
C:\Ruby193\bin\ruby.exe S:\resources\covermaker\bookmaker_covermaker.rb %1
