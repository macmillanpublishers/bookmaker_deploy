...
ruby S:\resources\bookmaker_scripts\bookmaker_addons\bookmaker_tests.rb '%infile%' '%2' '%3' '%4' >> %logfile% 2>&1 && call :ProcessLogger bookmaker_tests
